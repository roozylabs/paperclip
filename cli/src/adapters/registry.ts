...
import { printPrismRoozyLabsStreamEvent } from "@paperclipai/adapter-prism-roozylabs/cli";
...
const openCodeZenCLIAdapter: CLIAdapterModule = {
  type: "opencode_zen",
  formatStdoutEvent: printOpenCodeZenStreamEvent,
};
