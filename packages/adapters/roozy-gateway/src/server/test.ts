...
export async function testEnvironment(
  ...
  if (baseUrlRaw && !parsed) {
    checks.push({
      code: "roozy_gateway_base_url_invalid",
      level: "error",
  ...
  if (
    ...
    checks.push({
      code: "roozy_gateway_plain_http_denied",
      level: "error",
    ...
    checks.push({
      code: "roozy_gateway_plain_http_unsafe_allowed",
      level: "warn",
    ...
    checks.push({
      code: "roozy_gateway_loopback_http_allowed",
      level: "info",
  ...
  try {
    ...
    if (response.ok) {
      ...
      try {
        ...
        if (modelIds.includes(configuredModel)) {
          ...
          checks.push({
            code: "roozy_gateway_model_not_in_static_list",
            level: "warn",
        ...
        checks.push({
          code: "roozy_gateway_models_parse_error",
          level: "warn",
      ...
      checks.push({
        code: "roozy_gateway_probe_failed",
        level: "error",
    ...
    checks.push({
      code: "roozy_gateway_unreachable",
      level: "error",
